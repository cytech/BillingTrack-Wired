...
this.hook("instead","deleteSelection",i=>!!t.activeItems.length&&e.call(t,i))}),ct.define("remove_button",function(t){const e=this,i=Object.assign({label:"×",title:"Remove",className:"remove",tabindex:-1,role:"button",html:t=>{var e
const i=document.createElement("div")
return i.className=t.className||"",i.title=t.title||"",i.setAttribute("role",t.role||"button"),i.tabIndex=null!=(e=t.tabindex)?e:-1,i.textContent=t.label||"",i}},t)
e.hook("after","setupTemplates",()=>{var t=e.settings.render.item
e.settings.render.item=(s,n)=>{var o=K(t.call(e,s,n)),r=K(i.html(i))
return o.appendChild(r),R(r,"mousedown",t=>{q(t,!0)}),R(r,"click",t=>{e.isLocked||(q(t,!0),e.isLocked||e.shouldDelete([o],t)&&(e.removeItem(o),e.refreshOptions(!1),e.inputState()))}),o}})}),ct.define("restore_on_backspace",function(t){const e=this,i=Object.assign({text:t=>t[e.settings.labelField]},t)
