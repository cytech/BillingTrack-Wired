...
class LivewireSelect extends Component
{
    ...
    public function styles()
    {
        return [
            ...
            'searchSelectedOptionTitle' => 'text-gray-900 text-start',
            ...
            'searchOptionItemActive'    => 'list-group-item-action bg-primary',
            'searchOptionItemInactive'  => 'bg-white text-gray-600',
            'searchNoResults'           => 'text-bold text-center text-xs text-red',
            // tailwind
