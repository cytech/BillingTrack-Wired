...
class ConvertCustomTemplates
{
    ...
    public static function copy(): void
    {
        ...
        foreach ($customQuoteTemplates as $file){
            File::copy(base_path('custom/templates/quote_templates/' . $file), base_path('custom/templates/quote_templates/V7' . $file));
        }
        foreach ($customWorkorderTemplates as $file){
            File::copy(base_path('custom/templates/workorder_templates/' . $file), base_path('custom/templates/workorder_templates/V7' . $file));
        }
        foreach ($customInvoiceTemplates as $file){
            File::copy(base_path('custom/templates/invoice_templates/' . $file), base_path('custom/templates/invoice_templates/V7' . $file));
        }
        foreach ($customPurchaseorderTemplates as $file){
            File::copy(base_path('custom/templates/purchaseorder_templates/' . $file), base_path('custom/templates/purchaseorder_templates/V7' . $file));
        }
    }
