<script type="text/javascript">
    ready(function () {
        ...
        addEvent(document, 'click', ".btn-save-invoice", (e) => {
            const items = [];
            let display_order = 1;
            const custom_fields = {};
            ...
            document.querySelectorAll('.custom-form-field').forEach((e) => {
                const fieldName = e.target.dataset.invoicesFieldName
                if (fieldName !== undefined) {
                    custom_fields[e.target.dataset.invoicesFieldName] = e.target.value
                }
            });
            ...
            let data = {
                ...
                invoice_status_id: document.getElementById('invoice_status_id').value,
                items: items,
