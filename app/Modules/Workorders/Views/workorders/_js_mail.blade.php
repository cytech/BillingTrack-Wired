<script type="text/javascript">
    ready(function () {
        ...
        const modal = bsModal('modal-mail-workorder')
        modal.show()
        modaleL = document.getElementById('modal-mail-workorder')
        ...
        document.getElementById('btn-submit-mail-workorder').addEventListener('click', () => {
            const btn = e.target
            ...
            axios.post('{{ route('workorderMail.store') }}', {
