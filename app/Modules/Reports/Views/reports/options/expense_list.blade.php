    ...
    <script type="text/javascript">
        ready(function () {
            addEvent(document, 'click', "#btn-run-report", (e) => {
                ...
                axios.post("{{ route('reports.expenseList.validate') }}", {
                    from_date: from_date,
                    to_date: to_date,
                    ...
                    if (output_type === 'preview') {
                        ...
                        document.getElementById('preview-results').setAttribute('src', "{{ route('reports.expenseList.html') }}" + query_string)
    ...
    <section class="container-fluid">
        ...
        <div class="card card-light">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <label class="form-label fw-bold">@lang('bt.category'):</label>
                        {!! Form::select('category_id', $categories, null, ['id' => 'category_id', 'class' => 'form-select'])  !!}
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3">
                        <label class="form-label fw-bold">@lang('bt.vendor'):</label>
                        {!! Form::select('vendor_id', $vendors, null, ['id' => 'vendor_id', 'class' => 'form-select'])  !!}
                    </div>
                </div>
                <div class="row">
