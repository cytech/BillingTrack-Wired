    ...
    <script type="text/javascript">
        ready(function () {
            addEvent(document, 'click', "#btn-run-report", (e) => {
                ...
                axios.post("{{ route('reports.vendorPayments.validate') }}", {
                    from_date: from_date,
                    to_date: to_date,
                    ...
                    if (output_type === 'preview') {
                        ...
                        document.getElementById('preview-results').setAttribute('src', "{{ route('reports.vendorPayments.html') }}" + query_string)
                    } else if (output_type === 'pdf') {
                        window.location.href = "{{ route('reports.vendorPayments.pdf') }}" + query_string;
                    }
...
@section('content')
    <section class="app-content-header">
        <div class="container-fluid">
            <div class="col-sm-12">
                <div class="fs-3 float-start">@lang('bt.vendor_payments')</div>
