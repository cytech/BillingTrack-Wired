    ...
    <script type="text/javascript">
        ready(function () {
            addEvent(document, 'click', "#btn-run-report", (e) => {
                ...
                const include_profit_based_on = document.getElementById('include_profit_based_on').value

                axios.post("{{ route('reports.profitLoss.validate') }}", {
                    from_date: from_date,
                    to_date: to_date,
                    ...
                    if (output_type === 'preview') {
                        ...
                        document.getElementById('preview-results').setAttribute('src', "{{ route('reports.profitLoss.html') }}" + query_string)
...
@section('content')
    <section class="app-content-header">
        <div class="container-fluid">
            <div class="col-sm-12">
                <div class="fs-3 float-start">@lang('bt.profit_and_loss')</div>
    ...
    <section class="container-fluid">
        ...
        <div class="card card-light">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <label class="form-label fw-bold">@lang('bt.include_profit_based_on'):</label>
                        {!! Form::select('include_profit_based_on', ['invoice_date' => trans('bt.invoice_date'), 'payment_date' => trans('bt.payment_date')], null, ['id' => 'include_profit_based_on', 'class' => 'form-select'])  !!}
                    </div>
                </div>
                <div class="row">
