    ...
    <script type="text/javascript">
        ready(function () {
            addEvent(document, 'click', "#btn-run-report", (e) => {
                ...
                const exclude_unpaid_invoices = document.getElementById('exclude_unpaid_invoices').value

                axios.post("{{ route('reports.taxSummary.validate') }}", {
                    from_date: from_date,
                    to_date: to_date,
                    ...
                    if (output_type === 'preview') {
                        ...
                        document.getElementById('preview-results').setAttribute('src', "{{ route('reports.taxSummary.html') }}" + query_string)
...
@section('content')
    <section class="app-content-header">
        <div class="container-fluid">
            <div class="col-sm-12">
                <div class="fs-3 float-start">@lang('bt.tax_summary')</div>
    ...
    <section class="container-fluid">
        ...
        <div class="card card-light">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        <label class="form-label fw-bold">@lang('bt.exclude_unpaid_invoices'):</label>
                        {!! Form::select('exclude_unpaid_invoices', ['0' => trans('bt.no'), '1' => trans('bt.yes')], null, ['id' => 'exclude_unpaid_invoices', 'class' => 'form-select'])  !!}
                    </div>
                </div>
                <div class="row">
