...
class Workorders implements SourceInterface
{
    public function getResults($params = [])
    {
        $workorder = Workorder::select('documents.number', 'documents.created_at', 'documents.updated_at', 'documents.action_date',
        ...
        return $workorder->get()->makeHidden(['formatted_document_date', 'formatted_action_date','status_text', 'formatted_summary'])->toArray();
    }
}
