...
class PurchaseorderItems implements SourceInterface
{
    public function getResults($params = [])
    {
        $purchaseorderItem = DocumentItem::whereHas('purchaseorder')->select('documents.number', 'document_items.created_at', 'document_items.name',
        ...
        return $purchaseorderItem->get()->toArray();
    }
}
