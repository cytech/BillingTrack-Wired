...
class WorkorderItems implements SourceInterface
{
    public function getResults($params = [])
    {
        $workorderItem = DocumentItem::whereHas('workorder')->select('documents.number', 'document_items.created_at', 'document_items.name',
        ...
        return $workorderItem->get()->toArray();
    }
}
