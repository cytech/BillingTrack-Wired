...
class Invoices implements SourceInterface
{
    ...
    {
        $invoice = Invoice::select('documents.number', 'documents.created_at', 'documents.updated_at', 'documents.document_date',
        ...
        return $invoice->get()->makeHidden(['formatted_document_date', 'formatted_action_date', 'formatted_summary'])->toArray();
    }
}
