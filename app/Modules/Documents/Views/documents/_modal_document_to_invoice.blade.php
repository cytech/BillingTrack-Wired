@include('documents._js_document_to_invoice')
<div class="modal fade" id="modal-document-to-invoice">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="row g-3 mb-3 align-items-center">
                        ...
                        <div class="col-sm-6">
                            {{ html()->select('group_id', $groups, config('bt.invoiceGroup'))->class('form-select')->attribute('id', 'to_invoice_group_id') }}
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" id="btn-document-to-invoice-submit"
