<script type="text/javascript">
    ready(function () {
        ...
        const modal = bsModal('modal-mail-purchaseorder')
        modal.show()
        modaleL = document.getElementById('modal-mail-purchaseorder')
        ...
        document.getElementById('btn-submit-mail-purchaseorder').addEventListener('click', (e) => {
            const btn = e.target
            ...
            axios.post('{{ route('purchaseorderMail.store') }}', {
