<div class="row">
    <div class="col-md-3">
        <div class="mb-3">
            ...
            {!! Form::select('setting[workorderTemplate]', $workorderTemplates, config('bt.workorderTemplate'), ['class' => 'form-select']) !!}
        </div>
    </div>
    <div class="col-md-3">
        <div class="mb-3">
            <label class="form-label fw-bold">@lang('bt.default_group'): </label>
            {!! Form::select('setting[workorderGroup]', $groups, config('bt.workorderGroup'), ['class' => 'form-select']) !!}
        </div>
    </div>
    <div class="col-md-3">
        <div class="mb-3">
    ...
    <div class="col-md-3">
        <div class="mb-3">
            ...
            {!! Form::select('setting[workorderStatusFilter]', $workorderStatuses, config('bt.workorderStatusFilter'), ['class' => 'form-select']) !!}
        </div>
    </div>
</div>
<div class="mb-3">
    <label class="form-label fw-bold">@lang('bt.convert_workorder_when_approved'): </label>
    {!! Form::select('setting[convertWorkorderWhenApproved]', $yesNoArray, config('bt.convertWorkorderWhenApproved'), ['class' => 'form-select']) !!}
</div>
<div class="mb-3">
    <label class="form-label fw-bold">@lang('bt.convert_workorder_setting'): </label>
    {!! Form::select('setting[convertWorkorderTerms]', $convertWorkorderOptions, config('bt.convertWorkorderTerms'), ['class' => 'form-select']) !!}
    {!! Form::select('setting[convertWorkorderDate]', $convertWorkorderDate, config('bt.convertWorkorderDate'), ['class' => 'form-select']) !!}
</div>
<div class="mb-3">
...
<div class="row">
    <div class="col-md-3">
        <div class="mb-3">
            ...
            {!! Form::select('setting[resetWorkorderDateEmailDraft]', $workorderWhenDraftOptions, config('bt.resetWorkorderDateEmailDraft'), ['class' => 'form-select']) !!}
        </div>
    </div>
