<div class="btn-group position-static">
    ...
    <div class="dropdown-menu dropdown-menu-end" role="menu">
        ...
        @if($model->document && !$model->document->trashed())
            <a class="dropdown-item" href ="{{ route('documents.pdf', [$model->document->id]) }}" target="_blank" id="btn-pdf-invoice"><i class="fa fa-print"></i> @lang('bt.pdf') @lang('bt.invoice')</a>
        @endif
        @if (config('bt.mailConfigured') && request('status') == 1)
