...
return [
    ...
    'messages' => [
        'widgetQuoteSummaryDashboardTotalsFromDate.required_if' => trans('bt.validation_quote_summary_from_date'),
        'widgetQuoteSummaryDashboardTotalsToDate.required_if' => trans('bt.validation_quote_summary_to_date'),
    ],
];
