        ...
        <div class="card-header align-content-center">
            ...
            <div class="card-tools float-end">
                ...
                <button class="btn btn-sm"
                        ...
                        onclick="window.Livewire.dispatch('showModal', {alias: 'modals.create-module-modal', params: { modulefullname: 'BT\\Modules\\Documents\\Models\\Invoice', module_type: 'Invoice', moduleop: 'create' }})"
