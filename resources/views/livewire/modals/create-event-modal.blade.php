    ...
    <div class="modal-body">
        ...
        <form id="saveCalendarEvent">
            ...
            <div class="row g-3 mb-3 align-items-center">
                ...
                <div class="col-sm-7">
                    {{ html()->select('category_id',$categories,null)->attributes( ['wire:model.live' => 'category_id', 'id' => 'category'])->class('form-select') }}
                </div>
            </div>
            <hr>
            <div class="row g-3 mb-3 align-items-center">
            ...
            <div class="row g-3 mb-3 align-items-center">
                ...
                <div class="col-sm-2">
                    <input wire:model.live="reminder_qty" type="number" id="reminder_qty" name="reminder_qty"
                           class="form-control" min="0"
                           value="0"/></div>
                <div class="col-auto">
                    <select wire:model="reminder_interval_id" id="reminder_interval" name="reminder_interval"
                            class="form-select">
