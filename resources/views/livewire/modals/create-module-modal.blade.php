        ...
        <form action="" method="get">
            ...
            @if($moduletype <> 'Recurringinvoice')
                <div class="row g-3 mb-3 align-items-center">
                    ...
                    <div class="col-sm-7">
                        <x-fp_common wire:model.blur="module_date"/>
            ...
            <div class="row g-3 mb-3 align-items-center">
                ...
                <div class="col-sm-7">
                    {{ html()->select('company_profile_id', $companyProfiles, null)->attributes(['wire:model.live' => 'company_profile_id','id' => 'company_profile_id'])->class('form-select') }}
                </div>
            </div>
            <div class="row g-3 mb-3 align-items-center">
                <div class="col-sm-4 text-end fw-bold">
                ...
                <div class="col-sm-7">
                    {{ html()->select('group_id', $groups, null)->attributes(['wire:model.live' => 'group_id','id' => 'group_id'])->class('form-select') }}
                </div>
            </div>
            @if($moduletype == 'Recurringinvoice')
                <div class="row g-3 mb-3 align-items-center">
                ...
                <div class="row g-3 mb-3 align-items-center">
                    ...
                    <div class="col-sm-7">
                        <div class="row">
                            <div class="col-sm-4">
                                {{ html()->select('recurring_frequency', array_combine(range(1, 90), range(1, 90)), null)->attributes( ['wire:model.live' => 'recurring_frequency', 'id' => 'recurring_frequency'])->class('form-select') }}
                            </div>
                            <div class="col-sm-7">
                                {{ html()->select('recurring_period', $frequencies, null)->attributes(['wire:model.live' => 'recurring_period', 'id' => 'recurring_period'])->class('form-select') }}
                            </div>
                        </div>
                    </div>
                </div>
