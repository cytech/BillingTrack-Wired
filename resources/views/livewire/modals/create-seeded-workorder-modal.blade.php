<div id="create-seeded-workorder-modal">
    ...
    <div class="modal-body">
        <form autocomplete="off">
            ...
            <div class="row g-3 mb-3 align-items-center">
                ...
                <div class="col-sm-7">
                    <input wire:model="summary" type="text" id="summary" name="summary" class="form-control"
            ...
            <div class="row g-3 mb-3 align-items-center">
                ...
                <div class="col-sm-2 form-check form-switch form-switch-md">
                    {{ html()->checkbox('will_call', null, 1)->attribute('wire:model', 'will_call')->class('form-check-input') }}
                </div>
            </div>
            <div class="row">
                            ...
                            <div wire:key="{{ $value->id }}">
                                ...
                                @if($value->driver)
                                    <label class="form-check-label mb-1"
                                           style="display:block;color:blue;">{{$value->short_name}}
                                    </label>
                                @else
                                    <label class="form-check-label mb-1" style="display:block;">{{$value->short_name}}
                                    </label>
                                @endif
                            </div>
                        @endforeach
                        ...
                        @foreach($available_resources as $key => $value)
                            <div wire:key="{{ $value->id }}">
                                <input class="form-check-input"
                                       ...
                                       wire:model.live="selected_resources"
                                       x-on:click="$wire.set('selected_qty.{{$value->id}}', 1, false)"
                                       value="{{$value->id}}"
                                       style="transform: scale(1.3);"
                                />
                                <label class="mb-1"
                                    ...
                                    <input
                                            ...
                                            wire:model="selected_qty.{{$value->id}}"
                                            min="0"
